...
export class ChatComponent extends LitElement {
  ...
  static override styles = css`
    :host {
      /* Base properties */
      --primary: var(--cba-primary, #07f);
      --error: var(--cba-error, #e30);
      --text-color: var(--cba-text-color, #000);
      --text-invert-color: var(--cba--text-invert-color, #fff);
      --disabled-color: var(--cba-disabled-color, #ccc);
      --bg: var(--cba-bg, #eee);
      --card-bg: var(--cba-card-bg, #fff);
      --card-shadow: var(--cba-card-shadow, 0 0.3px 0.9px rgba(0 0 0 / 12%), 0 1.6px 3.6px rgba(0 0 0 / 16%));
      --space-md: var(--cba-space-md, 12px);
      --space-xl: var(--cba-space-xl, calc(var(--space-md) * 2));
      --space-xs: var(--cba-space-xs, calc(var(--space-md) / 2));
      --space-xxs: var(--cba-space-xs, calc(var(--space-md) / 4));
      --border-radius: var(--cba-border-radius, 16px);
      --focus-outline: var(--cba-focus-outline, 2px solid);
      --overlay-color: var(--cba-overlay-color, rgba(0 0 0 / 40%));

      /* Component-specific properties */
      --error-color: var(--cba-error-color, var(--error));
      --error-border: var(--cba-error-border, none);
      --error-bg: var(--cba-error-bg, var(--card-bg));
      --retry-button-color: var(--cba-retry-button-color, var(--text-color));
      --retry-button-bg: var(--cba-retry-button-bg, #f0f0f0);
      --retry-button-bg-hover: var(--cba-retry-button-bg, #e5e5e5);
      --retry-button-border: var(--cba-retry-button-border, none);
      --suggestion-color: var(--cba-suggestion-color, var(--text-color));
      --suggestion-border: var(--cba-suggestion-border, none);
      --suggestion-bg: var(--cba-suggestion-bg, var(--card-bg));
      --suggestion-shadow: var(--cba-suggestion-shadow, 0 6px 16px -1.5px rgba(141 141 141 / 30%));
      --user-message-color: var(--cba-user-message-color, var(--text-invert-color));
      --user-message-border: var(--cba-user-message-border, none);
      --user-message-bg: var(--cba-user-message-bg, var(--primary));
      --bot-message-color: var(--cba-bot-message-color, var(--text-color));
      --bot-message-border: var(--cba-bot-message-border, none);
      --citation-color: var(--cba-citation-color, var(--text-invert-color));
      --bot-message-bg: var(--cba-bot-message-bg, var(--card-bg));
      --citation-bg: var(--cba-citation-bg, var(--primary));
      --citation-bg-hover: var(--cba-citation-bg, color-mix(in srgb, var(--primary), #000 10%));
      --new-chat-button-color: var(--cba-button-color, var(--text-invert-color));
      --new-chat-button-bg: var(--cba-new-chat-button-bg, var(--primary));
      --new-chat-button-bg-hover: var(--cba-new-chat-button-bg, color-mix(in srgb, var(--primary), #000 10%));
      --chat-input-color: var(--cba-chat-input-color, var(--text-color));
      --chat-input-border: var(--cba-chat-input-border, none);
      --chat-input-bg: var(--cba-chat-input-bg, var(--card-bg));
      --submit-button-color: var(--cba-button-color, var(--primary));
      --submit-button-border: var(--cba-submit-button-border, none);
      --submit-button-bg: var(--cba-submit-button-bg, none);
      --submit-button-bg-hover: var(--cba-submit-button-color, #f0f0f0);
    }
    *:focus-visible {
